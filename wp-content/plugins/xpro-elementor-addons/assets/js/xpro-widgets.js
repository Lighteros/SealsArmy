!(function (e, t) {
  ...
  let o = {
    ...
    BackgroundOverlay: function e(t) {
      t.hasClass("elementor-element-edit-mode") &&
        t.addClass("xpro-widget-bg-overlay");
    },
    ...
    SimplePortfolio: function (t) {
      ...
      function f(o, i) {
        ...
        "false" !== (d = e(o).data("src-preview")) &&
          ...
          t
            .find(
              ".xpro-preview .xpro-preview-prev-demo,.xpro-preview .xpro-preview-next-demo"
            )
            .removeClass("xpro-preview-inactive"),
          e(o).prev("[data-src-preview]").length <= 0 &&
            t
              .find(".xpro-preview .xpro-preview-prev-demo")
              .addClass("xpro-preview-inactive"),
          e(o).next("[data-src-preview]").length <= 0 &&
            t
      ...
      function m() {
        "1" === i.popup_animation &&
          c.to(t.find(".xpro-portfolio-loader-style-1 li"), {
            duration: 0.4,
            scaleX: 1,
            transformOrigin: "bottom right",
          }),
          "2" === i.popup_animation &&
            c.to(t.find(".xpro-portfolio-loader-style-2 li"), {
              duration: 0.4,
              scaleX: 1,
    ...
    PieChart: function (t) {
      ...
      t.find(".xpro-pie-chart").easyPieChart({
        ...
        barColor: function () {
          ...
          return (
            o.addColorStop(0, i.bar_color_1 || "#6ec1e4"),
            o.addColorStop(1, i.bar_color_2 || "#6ec1e4"),
            o
          );
        },
    ...
    HorizontalMenu: function (t) {
      ...
      if (
        (t.find(".dropdown li").each(function (t) {
          if (e("ul", this).length) {
            ...
            o.offset().left + o.width() <= e(window).width()
          ...
          t.find(".xpro-elementor-horizontal-navbar-nav li").each(function () {
            ...
            if (-1 !== l) {
              ...
              o &&
                ...
                t
                  .find(
                    ".xpro-elementor-horizontal-navbar-nav li:not(:first-child)"
                  )
            ...
            if (r.length) {
              ...
              t.stopPropagation(),
                e("html, body").animate(
                  {
                    scrollTop:
                      e(r).offset().top - (i.scroll_offset.size || 100) + 20,
                  },
                  500,
                  function () {
      ...
      if ("none" !== i.responsive_show) {
        ...
        n.on("click", function (e) {
          e.preventDefault(),
            t
              .find(".xpro-elementor-horizontal-navbar-wrapper")
              .toggleClass("active"),
            t
              .find(".xpro-elementor-horizontal-menu-overlay")
              .toggleClass("active");
        }),
          ...
          l.on("click", function (t) {
            e(window).width() < p &&
              ...
              e(this)
                .parent()
                .next(".xpro-elementor-dropdown-menu")
                .slideToggle());
          }),
          e(window).resize(function () {
            e(window).width() > p
              ? t.find(".xpro-elementor-dropdown-menu").show()
              : t.find(".xpro-elementor-dropdown-menu").hide(),
              t
                .find(".xpro-elementor-horizontal-navbar-wrapper")
                .removeClass("active"),
              t
    ...
    Team: function (t) {
      ...
      if (
        ...
        t.find(".xpro-team-inner-content").width(n),
          t.find(".xpro-team-inner-content").css("left", r + "px");
      }
      "14" === i.layout &&
    ...
    ContentToggle: function (t) {
      o.getElementSettings(t),
        t.find(".xpro-content-toggle-button").on("click", function (t) {
          t.preventDefault(),
            e(this)
              .parents(".xpro-content-toggle-button-wrapper")
              .toggleClass("active");
        });
    },
    NewsTicker: function (t) {
      ...
      e(".e-route-panel-editor-content").length &&
        (r = ".elementor-preview-responsive-wrapper"),
        n.owlCarousel({
          items: 1,
          smartSpeed: 1e3,
          loop: !0,
        ...
        e(i)
          ...
          .each(function (t, i) {
            e(i).prev().prop("colspan") > 1 &&
              ...
              e(i).prepend(
                '<div class="xpro-table-head-column-cell">' +
                  o.eq(t).html() +
                  "</div>"
              );
          });
    ...
    IconBox: function (e) {
      ...
      "" !== t.hover_animation &&
        ...
        t.lottie_url
          ? (r = t.lottie_url.url)
          : t.svg_upload && (r = t.svg_upload.url),
    ...
    HotSpot: function (t) {
      o.getElementSettings(t),
        ...
        t.find(".xpro-hotspot-type-click").on("click", function (t) {
          t.preventDefault(),
            e(this).find(".xpro-hotspot-tooltip-text").toggleClass("active");
        });
    },
    ...
    ContactForm: function (t) {
      let i = o.getElementSettings(t),
        ...
        r =
          (t.find(".xpro-contact-form-submit-button"),
          t.find(".xpro-contact-form-submit-button > i")),
        a = !1,
        l = n.attr("action");
      n.on("submit", function (o) {
        ...
        if (
          ...
          e.each(s, function (e, o) {
            "" !== o.value &&
              "g-recaptcha-response" !== o.name &&
              ((p[u] = {
                name:
                  t
                    .find("label[for=" + o.name.replaceAll("[]", "") + "]")
                    .text() || "",
                value: o.value,
              }),
              u++);
          ...
          p.length
            ...
            : (d = !1),
          t
            .find('.xpro-contact-form-require [required="required"]')
            .each(function (t) {
              "" === e(this).val() && (d = !1);
            }),
          !d)
          ...
          (c =
            ...
            "</div>"),
            t.find(".xpro-contact-form-message").hide().html(c).slideDown(),
            r.hide();
          return;
        }
        if (i.recaptcha && !a) {
            ...
            .done(function (e) {
              e.success
                ? ((c =
                    ...
                    "</div>"),
                  t
                    .find(".xpro-contact-form-message")
                    .hide()
                    .html(c)
                    .slideDown())
                : ((c =
      ...
      t.find(".xpro-woo-product-grid-item"),
        t.find(".xpro-hv-qv-btn").click(function (o) {
          ...
          e.ajax({
            ...
            cache: !1,
            beforeSend: function () {
              t.find(".xpro-qv-loader-wrapper").css("display", "unset"),
                t.find(".xpro-qv-popup-wrapper").css("display", "none");
            },
            complete: function () {
              t.find(".xpro-qv-loader-wrapper").css("display", "none"),
                t.find(".xpro-qv-popup-wrapper").css("display", "unset"),
                t
                  .find(".xpro-qv-popup-overlay")
            ...
            success: function (o) {
              t.find("#xpro_elementor_fetch_qv_data").html(o),
                e(".xpro-woo-qv-content-sec .variations_form")
                  ...
                  .trigger("change"),
                e(".xpro-woo-qv-content-sec .variations_form").trigger(
                  "wc_variation_form"
                );
            },
          });
        ...
        t.on(
          "click",
          "#xpro_elementor_fetch_qv_data .single_add_to_cart_button:not(.disabled)",
          function (o) {
            if (
              (o.preventDefault(),
              "" !== e(this).parents("form").attr("action"))
            )
              return (
                (window.location.href = e(this).parents("form").attr("action")),
                !1
              );
            ...
            if (
              ...
              t.find(".woocommerce-grouped-product-list-item").length)
            ) {
              let a = e("input.qty"),
                l = [];
              e.each(a, function (t, o) {
                let i = e(this).attr("name");
                (i = (i = i.replace("quantity[", "")).replace("]", "")),
                  (i = parseInt(i)),
                  e(this).val() && (l[i] = e(this).val());
              });
            }
            let s = i.serialize();
